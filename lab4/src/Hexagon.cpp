...
template std::istream& operator>>(std::istream& is, Hexagon<int>& h);
template std::istream& operator>>(std::istream& is, Hexagon<float>& h);
template std::istream& operator>>(std::istream& is, Hexagon<double>& h);

template std::ostream& operator<<(std::ostream& os, const Hexagon<int>& h);
template std::ostream& operator<<(std::ostream& os, const Hexagon<float>& h);
template std::ostream& operator<<(std::ostream& os, const Hexagon<double>& h);
