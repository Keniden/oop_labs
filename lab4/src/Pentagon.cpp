...
template std::istream& operator>>(std::istream& is, Pentagon<int>& p);
template std::istream& operator>>(std::istream& is, Pentagon<float>& p);
template std::istream& operator>>(std::istream& is, Pentagon<double>& p);

template std::ostream& operator<<(std::ostream& os, const Pentagon<int>& p);
template std::ostream& operator<<(std::ostream& os, const Pentagon<float>& p);
template std::ostream& operator<<(std::ostream& os, const Pentagon<double>& p);
