...
int main()
{
    ...
    std::cout << "five2 after move assignment from five5: " << five2 << std::endl;
    std::cout << "five5 after move: " << five5 << std::endl;

    std::cout << "five1 is equal to five2" << (five1 == five2) << std::endl;

    std::cout << "five1 is less than five3" << (five1 < five3) << std::endl;

    std::cout << "five3 is greater than five1" << (five3 > five1) << std::endl;
